...
{
    public class CustomerInteractionRepository : Repository<CustomerInteraction>, ICustomerInteractionRepository
    {
        public CustomerInteractionRepository(ApplicationDbContext context) : base(context)
        {
        }
    }
}
