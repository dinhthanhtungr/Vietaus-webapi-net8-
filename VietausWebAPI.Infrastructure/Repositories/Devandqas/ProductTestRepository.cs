...
{
    public class ProductTestRepository : Repository<ProductTest>, IProductTestRepository    
    {
        public ProductTestRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
