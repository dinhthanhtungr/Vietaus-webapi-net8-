...
namespace VietausWebAPI.Infrastructure.Migrations
{
    ...
    [Migration("20251008082226_updateWareHouse2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.DeliveryOrder", b =>
                {
                    ...
                    b.Property<string>("ExportExternalIdSnapShot")
                        .HasColumnType("citext");
                    ...
                    b.HasIndex(new[] { "CreateBy" }, "IX_DeliveryOrders_CreatedBy");

                    b.HasIndex(new[] { "CustomerId" }, "IX_DeliveryOrders_CustomerId");

                    b.HasIndex(new[] { "MerchandiseOrderId" }, "IX_DeliveryOrders_MerchandiseOrderId");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.DeliveryOrderDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "MfgProductionOrderId" }, "IX_DeliveryOrderDetail_MfgProductionOrderId");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.WarehouseRequestDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "RequestCode" }, "IX_WarehouseRequestDetail_RequestCode");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.WarehouseSnapshotSet", b =>
                {
                    b.Property<Guid>("SnapshotSetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValueSql("gen_random_uuid()");
                    ...
                    b.HasKey("SnapshotSetId")
                        .HasName("PK__WarehouseSnapshotSet__3214EC07A98DEC4E");

                    b.HasIndex("CreatedBy");

                    b.HasIndex("CompanyId", "VaCode", "CreatedDate");

                    b.ToTable("WarehouseSnapshotSet", "Warehouse");
                });
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.WarehouseTempStock", b =>
                {
                    ...
                    b.HasIndex("SnapshotSetId");

                    b.HasIndex("CompanyId", "SnapshotSetId");

                    b.HasIndex("CompanyId", "VaCode");

                    b.HasIndex("CompanyId", "TempType", "Code", "LotKey");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.DeliveryOrderDetail", b =>
                {
                    ...
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.MfgProductionOrder", "MfgProductionOrder")
                        ...
                        .HasConstraintName("FK_DeliveryOrderDetail_MfgProductionOrder");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.WarehouseRequestDetail", b =>
                {
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.WarehouseRequest", "WarehouseRequest")
                        ...
                        .HasConstraintName("FK_WarehouseRequestDetail_RequestCode");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.WarehouseSnapshotSet", b =>
                {
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.Company", "Company")
                        .WithMany("WarehouseSnapshotSets")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_WarehouseSnapshotSet_Company");

                    b.HasOne("VietausWebAPI.Core.Domain.Entities.Employee", "CreatedByNavigation")
                        .WithMany("WarehouseSnapshotSetCreatedByNavigations")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_WarehouseSnapshotSe_CreatedBy");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.WarehouseTempStock", b =>
                {
                    ...
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.WarehouseSnapshotSet", "SnapshotSet")
                        .WithMany("WarehouseTempStocks")
                        .HasForeignKey("SnapshotSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CreatedByNavigation");

                    b.Navigation("SnapshotSet");
                });
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.Company", b =>
                {
                    ...
                    b.Navigation("WarehouseSnapshotSets");
                });
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.Employee", b =>
                {
                    ...
                    b.Navigation("WarehouseSnapshotSetCreatedByNavigations");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.WarehouseSnapshotSet", b =>
                {
                    b.Navigation("WarehouseTempStocks");
                });
