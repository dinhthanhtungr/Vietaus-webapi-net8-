...
namespace VietausWebAPI.Infrastructure.Migrations
{
    ...
    [Migration("20250922031634_updateManufactoryImportNewTable")]
    partial class updateManufactoryImportNewTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.ManufacturingFormula", b =>
                {
                    ...
                    b.Property<string>("CheckNameSnapshot")
                        .HasColumnType("text")
                        .HasColumnName("checkNameSnapshot");
                    ...
                    b.ToTable("ManufacturingFormulas", (string)null);
                });
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.ManufacturingFormulaMaterial", b =>
                {
                    ...
                    b.ToTable("ManufacturingFormulaMaterials", (string)null);
                });
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.MfgProductionOrder", b =>
                {
                    ...
                    b.ToTable("MfgProductionOrders", (string)null);
                });
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.ManufacturingFormula", b =>
                {
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.Employee", "CheckByNavigation")
                        ...
                        .HasForeignKey("CheckBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK__Mf__checkBy");
                    ...
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.Employee", null)
                        .WithMany("ManufacturingFormulaCheckByNavigations")
                        .HasForeignKey("EmployeeId");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.ManufacturingFormulaMaterial", b =>
                {
                    ...
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.Category", null)
                    ...
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.Material", null)
                        .WithMany("ManufacturingFormulaMaterials")
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.Employee", b =>
                {
                    ...
                    b.Navigation("ManufacturingFormulaCheckByNavigations");
