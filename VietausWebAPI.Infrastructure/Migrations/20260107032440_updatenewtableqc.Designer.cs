...
namespace VietausWebAPI.Infrastructure.Migrations
{
    ...
    [Migration("20260107032440_updatenewtableqc")]
    partial class updatenewtableqc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.DevandqaSchema.QCInputByQC", b =>
                {
                    ...
                    b.Property<bool?>("IsAllowInput")
                        .HasColumnType("boolean")
                        .HasColumnName("isallowinput");

                    b.Property<bool?>("IsCheckCOA")
                        .HasColumnType("boolean")
                        .HasColumnName("ischeckcoa");

                    b.Property<bool?>("IsCheckMSDSTDS")
                        .HasColumnType("boolean")
                        .HasColumnName("ischeckmsdstds");

                    b.Property<bool?>("IsCheckMetalDetection")
                        .HasColumnType("boolean")
                        .HasColumnName("ischeckmetaldetection");

                    b.HasKey("QCInputByQCId");

                    b.HasIndex("InspectionMethod")
                        .HasDatabaseName("ix_qcinputbyqc_inspectionmethod");

                    b.HasIndex("IsAllowInput")
                        .HasDatabaseName("ix_qcinputbyqc_isallowinput");

                    b.ToTable("QCInputByQC", "devandqa");
                });

            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.DevandqaSchema.QCInputByWarehouse", b =>
                {
                    b.Property<Guid>("QCInputByWarehouseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("QCInputByWarehouseId");

                    b.HasIndex("CreatedDate")
                        .HasDatabaseName("ix_qcinputbywarehouse_createddate");

                    b.HasIndex("CustomerId")
                        .HasDatabaseName("ix_qcinputbywarehouse_customerid");
                    ...
                    b.HasIndex("QCInputByQCId")
                        .HasDatabaseName("ix_qcinputbywarehouse_qcinputbyqcid");

                    b.ToTable("QCInputByWarehouse", "devandqa");
                });
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.DevandqaSchema.QCInputByWarehouse", b =>
                {
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.CustomerSchema.Customer", "Customer")
                        .WithMany("QCInputByWarehouses")
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_QCInputByWarehouse_Customer");
                    ...
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.DevandqaSchema.QCInputByQC", "QCInputByQC")
                        .WithMany("QCInputByWarehouses")
                        .HasForeignKey("QCInputByQCId")
                        .IsRequired()
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.CustomerSchema.Customer", b =>
                {
                    ...
                    b.Navigation("QCInputByWarehouses");
