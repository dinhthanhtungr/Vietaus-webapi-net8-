...
namespace VietausWebAPI.Infrastructure.Migrations
{
    ...
    [Migration("20260124020939_updateformualamaterialid13")]
    partial class updateformualamaterialid13
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.CustomerSchema.Customer", b =>
                {
                    ...
                    b.ToTable("Customer", "Customer", t =>
                        {
                            t.Property("RegistrationAddress")
                                .HasColumnName("RegistrationAddress1");
                        });
                });
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.DevandqaSchema.QCInputByQC", b =>
                {
                    ...
                    b.Property<int>("WarehouseRequestDetailId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("WarehouseRequestDetailId")
                        .HasDatabaseName("ix_qcinputbyqc_warehouserequestdetailid");
            ...
            modelBuilder.Entity("VietausWebAPI.Core.Domain.Entities.DevandqaSchema.QCInputByQC", b =>
                {
                    ...
                    b.HasOne("VietausWebAPI.Core.Domain.Entities.WarehouseSchema.WarehouseRequestDetail", "RequestDetail")
                        .WithMany("QCInputByQCs")
                        .HasForeignKey("WarehouseRequestDetailId")
                        .IsRequired()
                        .HasConstraintName("FK_QCInputByQC_WarehouseRequestDetail");
