...
namespace VietausWebAPI.Infrastructure.DatabaseContext.ApplicationDbs
{
    public partial class ApplicationDbContext
    {
        ...
        public virtual DbSet<ManufacturingFormulaAdjustment> ManufacturingFormulaAdjustments { get; set; } = default!;
        public virtual DbSet<ManufacturingFormulaAdjustmentBatch> ManufacturingFormulaAdjustmentBatches { get; set; } = default!;
        public virtual DbSet<ManufacturingFormulaAdjustmentItem> ManufacturingFormulaAdjustmentItems { get; set; } = default!;
