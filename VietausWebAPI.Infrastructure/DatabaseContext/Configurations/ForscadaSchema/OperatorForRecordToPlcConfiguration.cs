...
{
    public sealed class OperatorForRecordToPlcConfiguration : IEntityTypeConfiguration<OperatorForRecordToPlc>
    {
        public void Configure(EntityTypeBuilder<OperatorForRecordToPlc> entity)
        {
            entity.HasNoKey();
            entity.ToTable("operatorforrecordto_plc", "forscada");
