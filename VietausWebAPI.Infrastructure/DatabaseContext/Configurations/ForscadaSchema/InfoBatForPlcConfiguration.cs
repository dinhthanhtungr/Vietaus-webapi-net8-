...
{
    public sealed class InfoBatForPlcConfiguration : IEntityTypeConfiguration<InfoBatForPlc>
    {
        public void Configure(EntityTypeBuilder<InfoBatForPlc> entity)
        {
            // Keyless vì bảng dùng đọc/hiển thị
            entity.HasNoKey();
            entity.ToTable("infobatfor_plc", "forscada");
