...
namespace VietausWebAPI.WebAPI.DatabaseContext
{
    ...
    // IdentityDbContext thì nó sẽ tự tạo ra các bản database về User cũng như về Role
    {
        ...
        public virtual DbSet<SequencePoMaterialDatum> SequencePoMaterialData { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Id); // ✅ Khóa chính thực sự

                entity.HasOne(e => e.ProductInspection)
                      .WithOne(p => p.QCDetail)
                      .HasForeignKey<QCDetail>(e => e.BatchId) // ✅ ForeignKey trỏ tới ProductInspection
                      .HasPrincipalKey<ProductInspection>(p => p.Id) // ✅ trỏ vào khóa chính ProductInspection
            ...
            modelBuilder.Entity<SequencePoMaterialDatum>(entity =>
            {
                entity.HasKey(e => e.Year).HasName("PK__Sequence__D4BD6055431D8685");

                entity.ToTable("SequencePO_material_data");
