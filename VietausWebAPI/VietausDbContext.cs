...
public partial class VietausDbContext : DbContext
{
    public VietausDbContext()
    {
    }

    public VietausDbContext(DbContextOptions<VietausDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=Localhost;Port=5432;Database=VietausDb;Username=postgres;Password=qazwsxedc123@");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AspNetRole>(entity =>
        {
            ...
            entity.Property(e => e.ConcurrencyStamp).HasColumnType("citext");
            entity.Property(e => e.Name).HasColumnType("citext");
            entity.Property(e => e.NormalizedName).HasColumnType("citext");
        });
        ...
        modelBuilder.Entity<AspNetRoleClaim>(entity =>
        {
            ...
            entity.Property(e => e.ClaimType).HasColumnType("citext");
            entity.Property(e => e.ClaimValue).HasColumnType("citext");
        ...
        modelBuilder.Entity<AspNetUser>(entity =>
        {
            ...
            entity.Property(e => e.NormalizedEmail).HasColumnType("citext");
            entity.Property(e => e.NormalizedUserName).HasColumnType("citext");
            entity.Property(e => e.PasswordHash).HasColumnType("citext");
            entity.Property(e => e.PersonName)
                .HasColumnType("citext")
                .HasColumnName("personName");
            entity.Property(e => e.PhoneNumber).HasColumnType("citext");
            entity.Property(e => e.RefreshToken).HasColumnType("citext");
            entity.Property(e => e.SecurityStamp).HasColumnType("citext");
            entity.Property(e => e.UserName).HasColumnType("citext");
        });
        ...
        modelBuilder.Entity<AspNetUserLogin>(entity =>
        {
            ...
            entity.Property(e => e.ProviderDisplayName).HasColumnType("citext");
        ...
        modelBuilder.Entity<AspNetUserToken>(entity =>
        {
            ...
            entity.Property(e => e.Value).HasColumnType("citext");
        ...
        modelBuilder.Entity<PriceHistory>(entity =>
        {
            ...
            entity.HasIndex(e => e.CreatedBy, "IX_PriceHistory_CreatedBy1");

            entity.HasIndex(e => e.ProductId, "IX_PriceHistory_ProductId");

            entity.HasIndex(e => e.UpdatedBy, "IX_PriceHistory_UpdatedBy1");
        ...
        modelBuilder.Entity<PriceHistory1>(entity =>
        {
            ...
            entity.HasOne(d => d.Material).WithMany(p => p.PriceHistory1s)
                .HasForeignKey(d => d.MaterialId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PriceHistory_Material");

            entity.HasOne(d => d.Supplier).WithMany(p => p.PriceHistory1s)
                .HasForeignKey(d => d.SupplierId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<ProductStandard>(entity =>
        {
            ...
            entity.HasIndex(e => e.CompanyId, "IX_ProductStandards_CompanyId");

            entity.HasIndex(e => e.CreatedBy, "IX_ProductStandards_CreatedBy");

            entity.HasIndex(e => e.ProductId, "IX_ProductStandards_ProductId");

            entity.HasIndex(e => e.UpdatedBy, "IX_ProductStandards_UpdatedBy");

            entity.Property(e => e.ProductStandardId).ValueGeneratedNever();
            entity.Property(e => e.BlackDots).HasMaxLength(50);
            entity.Property(e => e.ColourCode).HasMaxLength(50);
            entity.Property(e => e.CustomerExternalId).HasMaxLength(50);
            entity.Property(e => e.DeltaE).HasMaxLength(20);
            entity.Property(e => e.Density).HasMaxLength(20);
            entity.Property(e => e.DwellTime).HasMaxLength(50);
            entity.Property(e => e.ElongationAtBreak).HasMaxLength(20);
            entity.Property(e => e.ExternalId).HasMaxLength(50);
            entity.Property(e => e.FlexuralModulus).HasMaxLength(20);
            entity.Property(e => e.FlexuralStrength).HasMaxLength(20);
            entity.Property(e => e.Hardness).HasMaxLength(50);
            entity.Property(e => e.IzodImpactStrength).HasMaxLength(20);
            entity.Property(e => e.MeltIndex).HasMaxLength(20);
            entity.Property(e => e.MigrationTest).HasMaxLength(100);
            entity.Property(e => e.Moisture).HasMaxLength(20);
            entity.Property(e => e.Package).HasMaxLength(255);
            entity.Property(e => e.PelletSize).HasMaxLength(20);
            entity.Property(e => e.Shape).HasMaxLength(100);
            entity.Property(e => e.Status).HasMaxLength(50);
            entity.Property(e => e.TensileStrength).HasMaxLength(20);

            entity.HasOne(d => d.Company).WithMany(p => p.ProductStandards)
                .HasForeignKey(d => d.CompanyId)
                .HasConstraintName("FK_ProductStandards_Company");

            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.ProductStandardCreatedByNavigations)
                .HasForeignKey(d => d.CreatedBy)
                .HasConstraintName("FK_ProductStandards_CreatedBy");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductStandards)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK_ProductStandards_Product");

            entity.HasOne(d => d.UpdatedByNavigation).WithMany(p => p.ProductStandardUpdatedByNavigations)
                .HasForeignKey(d => d.UpdatedBy)
        ...
        modelBuilder.Entity<Qcdetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Batch).WithOne(p => p.Qcdetail)
