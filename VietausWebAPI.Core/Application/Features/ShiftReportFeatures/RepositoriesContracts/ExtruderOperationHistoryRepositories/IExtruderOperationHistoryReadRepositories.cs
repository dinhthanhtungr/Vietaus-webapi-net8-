...
namespace VietausWebAPI.Core.Application.Features.ShiftReportFeatures.RepositoriesContracts.ExtruderOperationHistoryRepositories
{
    public interface IExtruderOperationHistoryReadRepositories
    {
        /// <summary>
        /// Lấy dữ liệu lịch sử hoạt động của máy đùn theo mã sản phẩm hoặc externalId, có phân trang
        /// </summary>
        ...
        /// <summary>
        /// Lấy dữ liệu lịch sử hoạt động mới nhất của máy đùn theo externalId
        /// </summary>
        /// <param name="externalId">Mã định danh bên ngoài của máy đùn</param>
        /// <param name="cancellationToken">Token hủy bỏ</param>
        /// <returns>Lịch sử hoạt động mới nhất của máy đùn theo externalId</returns>
