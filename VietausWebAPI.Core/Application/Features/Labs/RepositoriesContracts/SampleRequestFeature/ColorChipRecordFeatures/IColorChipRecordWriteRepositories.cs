...
{
    public interface IColorChipRecordWriteRepositories : IRepository<ColorChipRecord>
    {
        /// <summary>
        /// Tạo lệnh query để truy vấn yêu cầu mẫu từ cơ sở dữ liệu.
        /// </summary>
        /// <returns></returns>
        IQueryable<ColorChipRecordDevelopmentFormula> QueryDetail(bool track = false);
        /// <summary>
        ...
        Task<ColorChipRecordDevelopmentFormula> ColorChipRecordDevelopmentFormulaCreateAsync(ColorChipRecordDevelopmentFormula entity, CancellationToken cancellationToken = default);
    }
}
