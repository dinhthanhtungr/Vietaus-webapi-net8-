...
namespace VietausWebAPI.Core.Application.Features.Labs.DTOs.QAQCFeature.ProductStandardFeature
{
    public class ProductStandardSummaryDTO
    {
        ...
        public string Packaging { get; set; } = string.Empty;       // Ví dụ: Bao bì Việt Úc 25 (Kg)
