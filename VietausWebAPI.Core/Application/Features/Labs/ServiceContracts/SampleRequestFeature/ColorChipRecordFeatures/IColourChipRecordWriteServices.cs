...
{
    public interface IColourChipRecordWriteServices
    {
        Task<OperationResult<SaveColorChipRecordResultDto>> CreateAsync(CreateColorChipRecordRequest request, CancellationToken cancellationToken = default);
    }
}
